...
@Component({
  selector: 'app-parallx',
  templateUrl: './parallx.component.html',
  styleUrls: ['./parallx.component.css']
})
export class ParallxComponent implements OnInit {
  ngOnInit() {
    gsap.registerPlugin(ScrollTrigger);
    let speed:number = 100;

/*  SCENE 1 */
let scene1:any = gsap.timeline();
